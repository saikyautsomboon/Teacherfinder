              ...
              <div class="widget big-stats-container">
                <div class="widget-content">
                  ...
                  <div id="big_stats" class="cf">
                    <div class="stat"><a href="{{route('teacherreq')}}"> <p style="font-size: 20px;"><b>Teacher Request list</b></p></a> 
                      <span class="value">
                    ...
                    <div class="stat"><a href="{{route('teacherlist')}}"><p style="font-size: 20px;"><b>Teacher list</b></p></a>
                      <span class="value">
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <ul class="messages_layout">
                <li class="from_user left"> <a href="#" class="avatar"><img src="{{asset('backend/img/message_avatar1.png')}}"/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="{{asset('backend/img/message_avatar2.png')}}"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
                ...
                <li class="from_user left"> <a href="#" class="avatar"><img src="{{asset('backend/img/message_avatar2.png')}}"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
