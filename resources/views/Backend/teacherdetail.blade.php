        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-6">
            <div class="about-img" data-aos="fade-right" data-aos-delay="100">
               <img src="{{asset($teacherdetail->user->profile)}}"  alt=""> 
              {{-- <h2>{{$teacherdetail->user->profile}}</h2> --}}
            </div>
          </div>
          ...
          <div class="col-lg-7 col-md-6">
            <div class="about-content" data-aos="fade-left" data-aos-delay="100">
              ...
              <p><span style="font-family: bold;">NAME:</span>
                <span style="color: gold;">{{$teacherdetail->user->name}}</span>
              </p>
              <p><span style="font-family: bold;">EMAIL:</span>
                <a><span style="color: gold;">{{$teacherdetail->user->email}}</span>
              </p>
              <p><span style="font-family: bold;">PHONE:</span>
                <span style="color: gold;">{{$teacherdetail->user->phone}}</span>
              </p>
              <p><span style="font-family: bold;">DOB:</span>
                <span style="color: gold;">{{$teacherdetail->dob}}</span>
              </p>
              <p><span style="font-family: bold;">ADDRESS:</span>
                <span style="color: gold;">{{$teacherdetail->user->address}}</span>
              </p>
              <p><span style="font-family: bold;">CV:</span>
                <span style="color: gold;">{{$teacherdetail->cv}}</span>
              </p>
              <p><span style="font-family: bold;">PORFOLIO:</span>
                <span style="color: gold;">{{$teacherdetail->porfolio}}</span>
              </p>
              <p><span style="font-family: bold;">SUBJECT:</span>
                <span style="color: gold;">{{$teacherdetail->subject->name}}</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="why-us-img">
              <img src="{{asset('frontend/teacher/assets/img/why-us.jpg')}}" alt="" class="img-fluid">
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row feature-item">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <img src="{{asset('frontend/teacher/assets/img/features-1.svg')}}" class="img-fluid" alt="">
          </div>
        ...
        <div class="row feature-item mt-5 pt-5">
          <div class="col-lg-6 wow fadeInUp order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="{{asset('frontend/teacher/assets/img/features-2.svg')}}" class="img-fluid" alt="">
          </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="{{asset('frontend/teacher/assets/img/portfolio/app1.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <img src="{{asset('frontend/teacher/assets/img/portfolio/web3.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">Web 3</a></h4>
                <p>Web</p>
                <div>
                  <a href="{{asset('frontend/teacher/assets/img/portfolio/web3.jpg')}}" class="link-preview venobox" data-gall="portfolioGallery" title="Web 3"><i class="ion ion-eye"></i></a>
                  <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <img src="{{asset('frontend/teacher/assets/img/portfolio/app2.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">App 2</a></h4>
                <p>App</p>
                <div>
                  <a href="{{asset('frontend/teacher/assets/img/portfolio/app2.jpg')}}" class="link-preview venobox" data-gall="portfolioGallery" title="App 2"><i class="ion ion-eye"></i></a>
                  <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="{{asset('frontend/teacher/assets/img/portfolio/card2.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">Card 2</a></h4>
                <p>Card</p>
                <div>
                  <a href="{{asset('frontend/teacher/assets/img/portfolio/card2.jpg')}}" class="link-preview venobox" data-gall="portfolioGallery" title="Card 2"><i class="ion ion-eye"></i></a>
                  <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <img src="{{asset('frontend/teacher/assets/img/portfolio/web2.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">Web 2</a></h4>
                <p>Web</p>
                <div>
                  <a href="{{asset('frontend/teacher/assets/img/portfolio/web2.jpg')}}" class="link-preview venobox" data-gall="portfolioGallery" title="Web 2"><i class="ion ion-eye"></i></a>
                  <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <img src="{{asset('frontend/teacher/assets/img/portfolio/app3.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">App 3</a></h4>
                <p>App</p>
                <div>
                  <a href="{{asset('frontend/teacher/assets/img/portfolio/app3.jpg')}}" class="link-preview venobox" data-gall="portfolioGallery" title="App 3"><i class="ion ion-eye"></i></a>
                  <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
